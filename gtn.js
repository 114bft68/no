...
function gtn() {
    ...
    submit.addEventListener('mousedown', eventGtn);
    submit.addEventListener('touchstart', eventGtn);
    ...
    document.getElementById('return3').addEventListener('mousedown', stop);
    document.getElementById('return3').addEventListener('touchstart', stop);
}

document.getElementById('btnG1').addEventListener('mousedown', gtn);
document.getElementById('btnG1').addEventListener('touchstart', gtn);