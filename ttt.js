...
function ttt() {
    ...
    var rect, x, y, nx, ny, sxy, sx, sy, tie, wol;
    var turn = true;
    ...
    canvas.addEventListener('mousedown', mdts);
    canvas.addEventListener('touchstart', mdts);
    ...
    function restartTtt() {
        document.getElementById('s1').style.display = 'flex';
        document.getElementById('s2').style.display = 'none';
        rect = x = y = nx = ny = sxy = sx = sy = tie = wol = undefined;
        turn = true;
    ...
    document.getElementById('tttrestartbtn').addEventListener('mousedown', restartTtt);
    document.getElementById('tttrestartbtn').addEventListener('touchstart', restartTtt);
    ...
    buttons[8].addEventListener('mousedown', () => {
        restartTtt();
        document.getElementById('s1').style.display = 'none';
    });
    buttons[8].addEventListener('touchstart', () => {
        restartTtt();
        document.getElementById('s1').style.display = 'none';
    });
}
